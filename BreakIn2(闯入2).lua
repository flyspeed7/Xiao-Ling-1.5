...
if game.PlaceId ~= 13864667823 then
	...
	local msg = Instance.new("Message",workspace)
msg.Text = "您已加入BreakIn2(大厅里)"
wait(3)
msg:Destroy()
		local OrionLib = loadstring(game:HttpGet("loadstringhttps://raw.githubusercontent.com/ScriptCentral-br/LibraryCentral/refs/heads/main/sc"))()
  ...
  Tab:AddLabel(" 功能是自己找的,获取东西是国外的 \n 他的开源库:https://github.com/ScriptCentral-br/")
  Tab:AddLabel(" 功能什么的是自己看Dex编辑的. \n 不喜欢的话可以找ks私聊:XL1145140008 \n 因为QQ模块所以QQ没了")
		local Tab = Window:MakeTab({
			Name = "免费通行证",
...
-- Tables
	...
	local function GiveItem(Item)
		...
		elseif Item == "撬棍(小)" or Item == "撬棍(大)" or Item == "棒球棍" or Item == "叉子" or Item == "锤子" or Item == "扳手" or Item == "扫把" then
			Events.Vending:FireServer(3, tostring(Item:gsub(" ", "")), "Weapons", LocalPlayer.Name, 1)
			Notify('已获取道具', "秋枫", 'rbxassetid://4483345998', 3)
		else
	...
	local function GetGAppleBadge()
		if game:GetService("Workspace"):FindFirstChild("FallenTrees") then
			...
			Notify("错了", "未知,请等Q3E4更新该脚本.", 'rbxassetid://4483345998', 3)
		end
	end
